...
```{r, echo=FALSE}
knitr::include_url("https://videocampus.urz.uni-leipzig.de/paella/ui/watch.html?id=5c6f7375-c590-4156-931f-a58eb8bc7dc1")
```
...
- [R for Data Science](https://r4ds.had.co.nz/workflow-projects.html) Kapitel 8 (R-Projects)

*Weiterführend*

- [R for Data Science](https://r4ds.had.co.nz/workflow-projects.html) Kapitel 11 (Data Import)
